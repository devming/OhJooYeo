...
extension DbManager {
    func addAdvertisement(advertisements: [Advertisement]?, worshipMO: WorshipMO?) {
...
//        saveAdvertisementToContext(advertisements, worshipMO: worshipMO)
    ...
    func updateAdvertisement(advertisements: [Advertisement]?, worshipMO: WorshipMO?) {
//        guard let advertisements = advertisements, let worshipMO = worshipMO else {
//            return
//        }
...
//        }
    ...
    private func saveAdvertisementToContext(_ advertisements: [Advertisement], worshipMO: WorshipMO) {
//        for advertisement in advertisements {
